...
namespace org.pdfclown.bytes
{
    ...
    public sealed class Stream : IInputStream, IOutputStream
    {
        ...
        public Stream(System.IO.Stream stream) { this.stream = stream; }
        ...
        public void Clear() { this.stream.SetLength(0); }
        ...
        public void Read(byte[] data) { _ = this.stream.Read(data, 0, data.Length); }

        public void Read(byte[] data, int offset, int count) { _ = this.stream.Read(data, offset, count); }

        public int ReadByte() { return this.stream.ReadByte(); }
        ...
        public sbyte ReadSignedByte() { throw new NotImplementedException(); }
        ...
        public void Seek(long offset) { _ = this.stream.Seek(offset, SeekOrigin.Begin); }

        public void Skip(long offset) { _ = this.stream.Seek(offset, SeekOrigin.Current); }
        ...
        public void Write(byte[] data) { this.stream.Write(data, 0, data.Length); }

        public void Write(string data) { this.Write(Encoding.Pdf.Encode(data)); }
        ...
        public void Write(byte[] data, int offset, int length) { this.stream.Write(data, offset, length); }
