    ...
    public abstract class Filter
    {
        ...
        public static Filter Get(PdfName name)
        {
            ...
            */
            ...
            else if (name.Equals(PdfName.LZWDecode) || name.Equals(PdfName.LZW))
            {
                throw new NotImplementedException("LZWDecode");
            }
            else if (name.Equals(PdfName.ASCIIHexDecode) || name.Equals(PdfName.AHx))
            {
                throw new NotImplementedException("ASCIIHexDecode");
            }
            else if (name.Equals(PdfName.ASCII85Decode) || name.Equals(PdfName.A85))
            {
                return ASCII85Filter;
            }
            else if (name.Equals(PdfName.RunLengthDecode) || name.Equals(PdfName.RL))
            {
                throw new NotImplementedException("RunLengthDecode");
            }
            else if (name.Equals(PdfName.CCITTFaxDecode) || name.Equals(PdfName.CCF))
            {
            ...
            else if (name.Equals(PdfName.DCTDecode) || name.Equals(PdfName.DCT))
            {
