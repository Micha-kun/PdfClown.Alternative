//-----------------------------------------------------------------------
// <copyright file="Length.cs" company="">
    ...
    public sealed class Length
    {
        ...
        public double GetValue(double baseValue)
        {
            switch (this.UnitMode)
            {
                ...
                default:
                    throw new NotSupportedException($"{this.UnitMode.GetType().Name} not supported.");
            }
        }

        public override string ToString() { return $"{this.Value} ({this.UnitMode})"; }
        ...
        /// </summary>
        ///
        public UnitModeEnum UnitMode { get; set; }
        ...
        /// </summary>
        /// <remarks>
        /// According to the applied unit mode, this value can be either an absolute measure or a ratio to be resolved
        /// through a base value.
        /// </remarks>
        ///
