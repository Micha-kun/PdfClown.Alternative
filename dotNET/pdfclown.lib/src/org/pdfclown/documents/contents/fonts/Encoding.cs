//-----------------------------------------------------------------------
// <copyright file="Encoding.cs" company="">
...
namespace org.pdfclown.documents.contents.fonts
{
    ...
    internal class Encoding
    {
        ...
        { this.Put(charCode, GlyphMapping.NameToCode(charName).Value); }

        protected void Put(int charCode, int unicode)
        { this.codes[new ByteArray(new byte[] { (byte)charCode })] = unicode; }

        public static Encoding Get(PdfName name) { return Encodings[name]; }

        public Dictionary<ByteArray, int> GetCodes() { return new Dictionary<ByteArray, int>(this.codes); }
    }
}
