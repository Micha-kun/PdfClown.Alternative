...
namespace org.pdfclown.documents.contents.fonts
{
    ...
    internal sealed class CMap
    {
        ...
        /// <param name="stream">Character map data.</param>
        ///
        public static IDictionary<ByteArray, int> Get(PdfStream stream) { return Get(stream.Body); }
        ...
        ///
        public static IDictionary<ByteArray, int> Get(PdfName name) { return Get((string)name.Value); }
        ...
        {
            using (var cmapResourceStream = Assembly.GetExecutingAssembly()
                                                .GetManifestResourceStream($"fonts.cmap.{name}"))
            {
