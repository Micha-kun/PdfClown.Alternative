...
namespace org.pdfclown.documents.contents.colorSpaces
{
    ...
    ///
    /// <summary>
    /// Paint that consists of a repeating graphical figure or a smoothly varying color gradient instead of a simple
    /// color [PDF:1.6:4.6].
    /// </summary>
    ///
    ...
    public abstract class Pattern : Color
    {
        ...
        public static Pattern Wrap(PdfDirectObject baseObject)
        {
            ...
            var patternType = ((PdfInteger)dictionary[PdfName.PatternType]).RawValue;
            switch (patternType)
            {
                case PatternType1:
        ...
        ///
        /// <summary>
        /// Gets the pattern matrix, a transformation matrix that maps the pattern's internal coordinate system to the
        /// default coordinate system of the pattern's parent content stream (the content stream in which the pattern is
        /// defined as a resource).
        /// </summary>
        /// <remarks>
        /// The concatenation of the pattern matrix with that of the parent content stream establishes the pattern
        /// coordinate space, within which all graphics objects in the pattern are interpreted.
        /// </remarks>
        ///
        public double[] Matrix
        {
            get
            {
                ...
                */
                var matrix = (PdfArray)this.Dictionary[PdfName.Matrix];
                if (matrix == null)
                {
                    return new double[]
                    {
