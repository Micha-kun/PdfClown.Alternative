//-----------------------------------------------------------------------
// <copyright file="LabColorSpace.cs" company="">
...
namespace org.pdfclown.documents.contents.colorSpaces
{
    ...
    ///
    /// <summary>
    /// CIE-based ABC double-transformation-stage color space, where A, B and C represent the L*, a* and b* components
    /// of a CIE 1976 L*a*b* space [PDF:1.6:4.5.4].
    /// </summary>
    ///
    ...
    public sealed class LabColorSpace : CIEBasedColorSpace
    {
        ...
        public IList<Interval<double>> Ranges
        {
            get
            {
                ...
                {
                    // 2. a* component.
                    ranges.Add(new Interval<double>(-100d, 100d));
                    // 3. b* component.
                    ranges.Add(new Interval<double>(-100d, 100d));
                }
                else
                {
                    // 2/3. a*/b* components.
                    for (int index = 0,
                        length = rangesObject.Count; index < length; index += 2)
                    {
                        ranges.Add(
                            new Interval<double>(
