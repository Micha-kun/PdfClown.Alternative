//-----------------------------------------------------------------------
// <copyright file="LeveledColor.cs" company="">
...
namespace org.pdfclown.documents.contents.colorSpaces
{
    ...
    public abstract class LeveledColor : Color
    {
        ...
        ///
        protected double GetComponentValue(int index) { return ((IPdfNumber)this.Components[index]).RawValue; }

        protected void SetComponentValue(int index, double value)
        { this.Components[index] = PdfReal.Get(NormalizeComponent(value)); }
        ...
        */
        protected PdfArray BaseArray => (PdfArray)this.BaseDataObject;
        ...
        public override bool Equals(object obj)
        {
            ...
            var objectIterator = ((LeveledColor)obj).BaseArray.GetEnumerator();
            var thisIterator = this.BaseArray.GetEnumerator();
            while (thisIterator.MoveNext())
            {
                _ = objectIterator.MoveNext();
        ...
        {
            var hashCode = 0;
            foreach (var component in this.BaseArray)
            {
        ...
        public sealed override IList<PdfDirectObject> Components => this.BaseArray;
    }
}
