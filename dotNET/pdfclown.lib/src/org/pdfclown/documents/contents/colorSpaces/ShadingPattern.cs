//-----------------------------------------------------------------------
// <copyright file="ShadingPattern.cs" company="">
...
namespace org.pdfclown.documents.contents.colorSpaces
{
    ...
    public sealed class ShadingPattern : Pattern
    {
        ...
        /// </summary>
        /// <remarks>
        /// Any parameters that are not so specified are inherited from the graphics state that was in effect at the
        /// beginning of the content stream in which the pattern is defined as a resource.
        /// </remarks>
        ///
        public ExtGState ExtGState => ExtGState.Wrap(((PdfDictionary)this.BaseDataObject)[PdfName.ExtGState]);
        ...
        /// </summary>
        ///
        public Shading Shading => Shading.Wrap(((PdfDictionary)this.BaseDataObject)[PdfName.Shading]);
    }
}
