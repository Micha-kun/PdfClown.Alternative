//-----------------------------------------------------------------------
// <copyright file="ColorSpace.cs" company="">
...
namespace org.pdfclown.documents.contents.colorSpaces
{
    ...
    {
        protected ColorSpace(PdfDirectObject baseObject) : base(baseObject)
        {
        }

        protected ColorSpace(Document context, PdfDirectObject baseDataObject) : base(context, baseDataObject)
        {
        }

        ///
        /// <summary>
        /// Gets the color value corresponding to the specified components interpreted according to this color space
        /// [PDF:1.6:4.5.1].
        /// </summary>
        ...
        ///
        public abstract Brush GetPaint(Color color);
        ...
        public static ColorSpace Wrap(PdfDirectObject baseObject)
        {
            ...
            */
            var name = (PdfName)((baseDataObject is PdfArray) ? ((PdfArray)baseDataObject)[0] : baseDataObject);
