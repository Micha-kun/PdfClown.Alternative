//-----------------------------------------------------------------------
// <copyright file="CalGrayColor.cs" company="">
...
namespace org.pdfclown.documents.contents.colorSpaces
{
    ...
    public sealed class CalGrayColor : LeveledColor
    {
        ...
        internal CalGrayColor(IList<PdfDirectObject> components) : base(null, new PdfArray(components))
        {
        }//TODO:colorspace?
