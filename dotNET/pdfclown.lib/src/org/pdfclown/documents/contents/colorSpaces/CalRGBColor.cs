//-----------------------------------------------------------------------
// <copyright file="CalRGBColor.cs" company="">
...
namespace org.pdfclown.documents.contents.colorSpaces
{
    ...
    public sealed class CalRGBColor : LeveledColor
    {
        ...
        internal CalRGBColor(IList<PdfDirectObject> components) : base(null, new PdfArray(components))
        {
        }//TODO:colorspace?

        public CalRGBColor(double r, double g, double b) : this(
