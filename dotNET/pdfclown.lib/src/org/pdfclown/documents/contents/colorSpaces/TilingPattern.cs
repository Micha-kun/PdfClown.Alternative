//-----------------------------------------------------------------------
// <copyright file="TilingPattern.cs" company="">
...
namespace org.pdfclown.documents.contents.colorSpaces
{
    ...
    public class TilingPattern : Pattern
    {
        ...
        private PdfDictionary BaseHeader => ((PdfStream)this.BaseDataObject).Header;
        ...
        {
            if (this.PaintType != PaintTypeEnum.Uncolored)
            {
        ...
        ///
        /// <summary>
        /// Gets the pattern cell's bounding box (expressed in the pattern coordinate system) used to clip the pattern
        /// cell.
        /// </summary>
        ///
        public RectangleF Box
        {
            get
            {
                ...
                */
                var box = org.pdfclown.objects.Rectangle.Wrap(this.BaseHeader[PdfName.BBox]);
        ...
        /// </summary>
        ///
        public PaintTypeEnum PaintType => (PaintTypeEnum)((PdfInteger)this.BaseHeader[PdfName.PaintType]).RawValue;
        ...
        /// </summary>
        ///
        public Resources Resources => Resources.Wrap(this.BaseHeader[PdfName.Resources]);
        ...
        /// </summary>
        ///
        public TilingTypeEnum TilingType => (TilingTypeEnum)((PdfInteger)this.BaseHeader[PdfName.TilingType]).RawValue;
        ...
        /// </summary>
        ///
        public double XStep => ((IPdfNumber)this.BaseHeader[PdfName.XStep]).RawValue;
        ...
        /// </summary>
        ///
        public double YStep => ((IPdfNumber)this.BaseHeader[PdfName.YStep]).RawValue;
        ...
        public sealed class Colorized : TilingPattern
        {
            ...
            internal Colorized(TilingPattern uncoloredPattern, Color color) : base(
        ...
        public enum PaintTypeEnum
        {
            ...
            /// </summary>
            /// <remarks>
            /// When the content stream begins execution, the current color is the one that was initially in effect in
            ...
            /// </summary>
            /// <remarks>
            /// <para>Instead, the entire pattern cell is painted with a separately specified color each time the
            /// pattern is used; essentially, the content stream describes a stencil through which the current color is
            /// to be poured.</para> <para>The content stream must not invoke operators that specify colors or other
            /// color-related parameters in the graphics state.</para>
            /// </remarks>
            ///
            Uncolored = 2
        }
        ...
        public enum TilingTypeEnum
        {
            ...
            ///
            /// <summary>
            /// The pattern cell is not distorted, but the spacing between pattern cells may vary by as much as 1 device
            ...
            ///
            /// <summary>
            /// Pattern cells are spaced consistently as in tiling type 1 but with additional distortion permitted to
            /// enable a more efficient implementation.
            /// </summary>
            ///
