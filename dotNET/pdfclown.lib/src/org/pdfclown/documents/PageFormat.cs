    ...
    */
    public sealed class PageFormat
    {
        ...
        private static readonly Regex IsoSeriesSizePattern = new Regex(
          $"([{IsoSeriesSize_A}{IsoSeriesSize_B}{IsoSeriesSize_C}])([\\d]+)"
          );
...
*/
        ...
        */
          ...
          )
        {
            ...
            var match = IsoSeriesSizePattern.Match(sizeName);
            // Is it an ISO standard size?
            if (match.Success)
            {
                int baseWidth;
                var isoSeriesSize = match.Groups[1].Value;
                ...
                var isoSeriesSizeIndex = int.Parse(match.Groups[2].Value);
                var isoSeriesSizeFactor = 1 / Math.Pow(2, isoSeriesSizeIndex / 2d);
            ...
            else // Non-ISO size.
            {
                switch (size)
                {
                    ...
                    case SizeEnum.Legal:
                        ...
                        height = 1008;
                        break;
                    case SizeEnum.Executive:
                        width = 522;
                        height = 756;
                        break;
                    case SizeEnum.Statement:
                        width = 396;
                        height = 612;
                        break;
                    default:
