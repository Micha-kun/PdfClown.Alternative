...
Document context
  ...
  PdfName key
        ...
        { return DeviceColor.Get((PdfArray)this.BaseDataObject.Resolve(key)); }

        private void SetColor(
          PdfName key,
          DeviceColor value
          )
        { this.BaseDataObject[key] = PdfObjectWrapper.GetBaseObject(value); }
...
*/
        public string AlternateCaption
        {
            get
            {
                var alternateCaptionObject = (PdfTextString)this.BaseDataObject[PdfName.AC];
                return (alternateCaptionObject != null) ? ((string)alternateCaptionObject.Value) : null;
            }
            set => this.BaseDataObject[PdfName.AC] = new PdfTextString(value);
        }
        ...
        */
        ...
        {
            get => FormXObject.Wrap(this.BaseDataObject[PdfName.IX]);
            set => this.BaseDataObject[PdfName.IX] = value.BaseObject;
        }
        ...
        */
        ...
        {
            get => this.GetColor(PdfName.BG);
            set => this.SetColor(PdfName.BG, value);
        }
        ...
        */
        ...
        {
            get => this.GetColor(PdfName.BC);
            set => this.SetColor(PdfName.BC, value);
        }
        ...
        */
        public CaptionPositionEnum CaptionPosition
        {
            get
            {
                var captionPositionObject = (PdfInteger)this.BaseDataObject[PdfName.TP];
                return (captionPositionObject != null) ? ((CaptionPositionEnum)captionPositionObject.RawValue) : CaptionPositionEnum.CaptionOnly;
            }
            set => this.BaseDataObject[PdfName.TP] = PdfInteger.Get((int)value);
        }
        ...
        */
        public IconFitObject IconFit
        {
            get
            {
                var iconFitObject = this.BaseDataObject[PdfName.IF];
                return (iconFitObject != null) ? new IconFitObject(iconFitObject) : null;
            }
            set => this.BaseDataObject[PdfName.IF] = PdfObjectWrapper.GetBaseObject(value);
        }
        ...
        */
        public string NormalCaption
        {
            get
            {
                var normalCaptionObject = (PdfTextString)this.BaseDataObject[PdfName.CA];
                return (normalCaptionObject != null) ? ((string)normalCaptionObject.Value) : null;
            }
            set => this.BaseDataObject[PdfName.CA] = PdfTextString.Get(value);
        }
        ...
        */
        ...
        {
            get => FormXObject.Wrap(this.BaseDataObject[PdfName.I]);
        ...
        */
        public OrientationEnum Orientation
        {
            get
            {
                var orientationObject = (PdfInteger)this.BaseDataObject[PdfName.R];
                return (orientationObject != null) ? ((OrientationEnum)orientationObject.RawValue) : OrientationEnum.Up;
            }
            set => this.BaseDataObject[PdfName.R] = PdfInteger.Get((int)value);
        }
        ...
        */
        public string RolloverCaption
        {
            get
            {
                var rolloverCaptionObject = (PdfTextString)this.BaseDataObject[PdfName.RC];
                return (rolloverCaptionObject != null) ? ((string)rolloverCaptionObject.Value) : null;
            }
            set => this.BaseDataObject[PdfName.RC] = PdfTextString.Get(value);
        }
        ...
        */
        ...
        {
            get => FormXObject.Wrap(this.BaseDataObject[PdfName.RI]);
            set => this.BaseDataObject[PdfName.RI] = PdfObjectWrapper.GetBaseObject(value);
        }
        /**
        ...
        */
          ...
          : PdfObjectWrapper<PdfDictionary>
        {
            ...
            */
            ...
            {
                foreach (var scaleMode in ScaleModeEnumCodes)
                {
            ...
            */
            ...
            {
                foreach (var scaleType in ScaleTypeEnumCodes)
                {
            ...
            */
            public bool BorderExcluded
            {
                get
                {
                    var borderExcludedObject = (PdfBoolean)this.BaseDataObject[PdfName.FB];
                    return (borderExcludedObject != null)
&& borderExcludedObject.RawValue;
                }
                set => this.BaseDataObject[PdfName.FB] = PdfBoolean.Get(value);
            }
            ...
            */
            ...
            {
                get => ToScaleModeEnum((PdfName)this.BaseDataObject[PdfName.SW]);
                set => this.BaseDataObject[PdfName.SW] = ToCode(value);
            }
            ...
            */
            ...
            {
                get => ToScaleTypeEnum((PdfName)this.BaseDataObject[PdfName.S]);
                set => this.BaseDataObject[PdfName.S] = ToCode(value);
            }
            ...
            */
            public XAlignmentEnum XAlignment
            {
                get
                {
                    var alignmentObject = (PdfArray)this.BaseDataObject[PdfName.A];
                ...
                PdfReal.Get(0.5)
                        ...
                        this.BaseDataObject[PdfName.A] = alignmentObject;
                    }
