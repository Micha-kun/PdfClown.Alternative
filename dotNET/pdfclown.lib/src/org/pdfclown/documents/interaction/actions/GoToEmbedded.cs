...
*/
        public PathElement DestinationPath
        {
            get
            {
                var targetObject = this.BaseDataObject[PdfName.T];
            ...
            set
            {
                ...
                { this.BaseDataObject[PdfName.T] = value.BaseObject; }
            }
        }
        /**
          ...
          : PdfObjectWrapper<PdfDictionary>
        {
            ...
            */
              ...
              ) : base(context, new PdfDictionary())
            {
                ...
                this.AnnotationPageRef = annotationPageRef;
...
*/
            ...
            */
            ...
            {
                foreach (var relation in RelationEnumCodes)
                {
...
Document context
            ...
            */
            public object AnnotationPageRef
            {
                get
                {
                    var pageRefObject = this.BaseDataObject[PdfName.P];
                ...
                {
                    if (value == null)
                    { _ = this.BaseDataObject.Remove(PdfName.P); }
                    else
                    {
                        ...
                        this.BaseDataObject[PdfName.P] = pageRefObject;
                    }
                }
            }
            ...
            */
            public object AnnotationRef
            {
                get
                {
                    var annotationRefObject = this.BaseDataObject[PdfName.A];
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.BaseDataObject[PdfName.A] = annotationRefObject;
                    }
                }
            }
            ...
            */
            public string EmbeddedFileName
            {
                get
                {
                    var fileNameObject = (PdfString)this.BaseDataObject[PdfName.N];
                    return (fileNameObject != null) ? ((string)fileNameObject.Value) : null;
                }
                set
                {
                    if (value == null)
                    { _ = this.BaseDataObject.Remove(PdfName.N); }
                    else
                    { this.BaseDataObject[PdfName.N] = new PdfString(value); }
                }
            }
            ...
            */
            ...
            {
                get => ToRelationEnum((PdfName)this.BaseDataObject[PdfName.R]);
                set => this.BaseDataObject[PdfName.R] = ToCode(value);
            }
            /**
