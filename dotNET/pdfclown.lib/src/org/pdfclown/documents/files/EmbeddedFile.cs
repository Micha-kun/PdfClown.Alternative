      ...
      : PdfObjectWrapper<PdfStream>
    {
        ...
        */
        public DateTime? CreationDate
        {
            get
            {
                var dateObject = (PdfDate)this.GetInfo(PdfName.CreationDate);
                return dateObject != null ? (DateTime?)dateObject.Value : null;
            }
            set => this.SetInfo(PdfName.CreationDate, PdfDate.Get(value));
        }

        /**
          <summary>Gets the data contained within this file.</summary>
        */
        public bytes::IBuffer Data => this.BaseDataObject.Body;
        ...
        */
        public string MimeType
        {
            get
            {
                var subtype = (PdfName)this.BaseDataObject.Header[PdfName.Subtype];
                return subtype != null ? (string)subtype.Value : null;
            }
            set => this.BaseDataObject.Header[PdfName.Subtype] = new PdfName(value);
        }
        ...
        */
        public DateTime? ModificationDate
        {
            get
            {
                var dateObject = (PdfDate)this.GetInfo(PdfName.ModDate);
                return (DateTime?)(dateObject != null ? dateObject.Value : null);
            }
            set => this.SetInfo(PdfName.ModDate, PdfDate.Get(value));
        }
        ...
        */
        public int Size
        {
            get
            {
                var sizeObject = (PdfInteger)this.GetInfo(PdfName.Size);
                return sizeObject != null ? sizeObject.IntValue : 0;
            }
            set => this.SetInfo(PdfName.Size, PdfInteger.Get(value));
        }
        #endregion
        ...
        */
        private PdfDictionary Params => this.BaseDataObject.Header.Resolve<PdfDictionary>(PdfName.Params);
